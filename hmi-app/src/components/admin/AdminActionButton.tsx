...
const ADMIN_ACTION_BUTTON_BASE_CLS = 'flex items-center gap-2 rounded-md px-4 py-1.5 text-xs font-bold transition-all';
...
const ADMIN_ACTION_BUTTON_VARIANT_CLS: Record<AdminActionButtonVariant, string> = {
    ...
    critical: 'uppercase tracking-widest border border-status-critical/40 bg-status-critical/10 text-status-critical hover:border-status-critical/60 hover:bg-status-critical/20 disabled:cursor-not-allowed disabled:border-white/5 disabled:bg-transparent disabled:text-industrial-muted disabled:opacity-50',
};
